...
class MemsDBServer {
    constructor(db, opts = {}) {
        ...
        const { port = 16055, secret = uuid_1.v4(), tokenExpiry = 86400, requireAuth = 'all', } = opts;
